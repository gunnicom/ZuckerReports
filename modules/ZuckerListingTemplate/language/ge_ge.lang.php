...
$mod_strings = array_merge($mod_strings, 
	array(
		...
		'LBL_LISTING_FILTER_VALUE' => 'Filterwert auswählen',
		'LBL_LISTING_FILTER_FROM_PARAM' => 'aus Parameter',
		'LBL_LISTING_FILTER_FROM_ENUM' => 'oder auswählen',
		'LBL_LISTING_FILTER_FROM_INPUT' => 'oder eingeben',
		
		'LBL_LISTING_FILTER_DESC' => 'Filterkriterium',
		'LBL_LISTING_FILTER_NEW' => 'Neuer Filter',
		'LBL_LISTING_FILTER_ADD' => 'Filter hinzufügen',
		'LBL_LISTING_FILTER_DELETE' => 'Filter löschen',
		...
		'LBL_LISTING_ORDER_ADD' => 'Sortierkriterium hinzufügen',
		'LBL_LISTING_ORDER_DELETE' => 'Sortierkriterium löschen',
		...
		'LBL_LISTING_WARNING_CHANGE_MAINMODULE' => 'Achtung: Ändern des Listen-Moduls führt zur automatischen Entfernung aller für diese Listenvorlage momentan definierten Filter- und Sortierkriterien!',
		
		'ERR_LISTING_NO_TEMPLATE' => 'Für diese Listenvorlage wurden keine Ausgabevorlagen gefunden. Bitte nehmen Sie die notwendigen Einstellungen vor in modules/ZuckerListingTemplate/lists/config.php',
	)
);
...
$mod_list_strings = array_merge($mod_list_strings,
	array (
		'LISTING_FILTER_TYPES' =>
		  array (
			'AND' => 'ALLE Filter müssen zutreffen',
